...
function Card ({name}) {
    ...
    return (
        <>
            <div className="flex font-sans my-8">
                <div className="flex-none w-56 relative">
                    <img src="https://images.pexels.com/photos/2026960/pexels-photo-2026960.jpeg?auto=compress&cs=tinysrgb&w=300" alt="" className="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
                </div>
